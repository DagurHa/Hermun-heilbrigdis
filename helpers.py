...
STARFSDEMAND = {
    STATES[0]: [20,3],      #Miðum við að hver legudeild rúmi 20 sjúklinga og að hver legudeild hafi 3 lækna
    STATES[1] : [12,1]      #Miðum við að hver göngudeildarlæknir geti séð 12 sjúklinga á dag
}
